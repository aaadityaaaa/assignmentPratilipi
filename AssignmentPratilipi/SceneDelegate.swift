...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createNewsNavigationController() -> UINavigationController {
        let newsVC =  NewsVC()
        newsVC.title = "Library"
        newsVC.tabBarItem = UITabBarItem(title: "Library", image: UIImage(systemName: "text.book.closed"), tag: 1)
    ...
    func createSearchNavigationController() -> UINavigationController {
        let newsVC =  NewsVC()
        newsVC.title = "Search"
        newsVC.tabBarItem = UITabBarItem(title: "Search", image: UIImage(systemName: "magnifyingglass"), tag: 1)
        return UINavigationController(rootViewController: newsVC)
    ...
    func createWriteNavigationController() -> UINavigationController {
        let newsVC =  NewsVC()
        newsVC.title = "Write"
        newsVC.tabBarItem = UITabBarItem(title: "Write", image: UIImage(systemName: "highlighter"), tag: 1)
        return UINavigationController(rootViewController: newsVC)
